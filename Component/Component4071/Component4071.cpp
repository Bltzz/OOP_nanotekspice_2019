...
Component4071::Component4071(std::string const name) {
    this->name = name;
    this->type = "4071";
    this->numPins = 13;
...
nts::Tristate Component4071::or_gate(nts::Tristate t1, nts::Tristate t2){
    if (t1 == nts::Tristate::FALSE && t2 == nts::Tristate::FALSE)
        return nts::Tristate::FALSE;
    else if ((t1 == nts::Tristate::TRUE || t2 == nts::Tristate::TRUE))
        return nts::Tristate::TRUE;
    return nts::Tristate::UNDEFINED;
}

nts::Tristate Component4071::pin3(){
    ...
    return or_gate(var1, var2);
}

nts::Tristate Component4071::pin4(){
...
nts::Tristate Component4071::pin10(){
...
nts::Tristate Component4071::pin11(){
...
nts::Tristate Component4071::compute(std::size_t pin = 1){
    if (pin == 3)
        return pin3();
    else if (pin == 4)
        return pin4();
        ...
        return pin11();
    return nts::Tristate::UNDEFINED;
    //return this->pins[pin]->getComponent()->compute(pin);
}